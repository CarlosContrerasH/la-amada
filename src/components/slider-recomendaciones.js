...
Para muchos buzos principiantes, Cancún es ideal para adquirir su primera certificación. Seis tiendas de buceo certificadas por PADI ofrecen excursiones a las cristalinas aguas caribeñas para observar la gran variedad y colorida vida marina. Para los más experimentados, están las atracciones únicas de la costa, y el reto de bucear en un cenote.
                    ...
                    {this.state.active == 3 ? < >
                        <span className="wrapped-header ubicacion" style={{ marginLeft: "0" }}>
                            <h2> {this.props.eng == true ? <>Shopping</> : <>Compras</>}</h2>
                        </span>
                        {this.props.eng == true ? <p>If you want a bit of city buzz, Cancun is just 30 minutes away. Cancun is well served for cutting edge fashion and well-known brands, with no fewer than eight major shopping malls and many large scale North American retailers. For those who are looking for a more distinctly Mexican experience, bustling local markets sell souvenirs and artisanal crafts, both to savvy purchasers and casual tourists alike.</p> : <p>Al llegar a La Amada, es fácil olvidar que Cancún Centro está a solo 12km. La ciudad cuenta con una gran variedad de tiendas de moda nacionales y extranjeras así como tiendas departamentales establecidas en ocho grandes centros comerciales. </p>
                        }
                    </ > : ""}
                    ...
                    {this.state.active == 5 ? <>
                        <span className="wrapped-header ubicacion" style={{ marginLeft: "0" }}>
                            <h2> {this.props.eng == true ? <>Food & Restaurants</> : <>Cocina</>}</h2>
                        </span>
                        {this.props.eng == true ? <p>Downtown & Zona Hotelera Cancun offer a contemporary dining scene, with high quality restaurants serving international menus at very competitive costs. For those seeking a more authentic local experience, our local beachside eateries serve the freshest and most amazing local seafood. We recommend speaking to the front desk to arrange a reservation at local hidden gems. Our personal favorite is Mar y Aroma, our <a href="/amenidades/la-amada/beachclub-restaurant">Beachclub Restaurant.</a> </p> : <p>El centro de Cancún y malecón de la Zona Hotelera, ofrece una variedad de restaurantes contemporáneos de la mejor calidad a precio razonable. Aquellos que buscan comida más local, podrán encontrar restaurantes en la playa que sirven los más frescos y deliciosos mariscos, sugerimos preguntes a nuestra concierge su recomendación para un restaurante local típico aunque sin lugar a duda nuestro favorito es Mar y Aroma, nuestro <a href="/amenidades/la-amada/beachclub-restaurant">Beachclub Restaurant.</a></p>
                        }
                    </> : ""}
                    ...
                    {this.state.active == 6 ? <>
                        <span className="wrapped-header ubicacion" style={{ marginLeft: "0" }}>
                            <h2> {this.props.eng == true ? <>Fishing at sea</> : <>Pesca en alta mar</>}</h2>
                        </span>
                    ...
                    {this.state.active == 7? <>
                        <span className="wrapped-header ubicacion" style={{ marginLeft: "0" }}>
                            <h2> {this.props.eng == true ? <>YUCATAN PENINSULA</> : <>PENÍNSULA DE YUCATÁN</>}</h2>
                        </span>
                        {this.props.eng == true ? <> <p>The magic of the Mayan culture continues north on the Yucatan Peninsula.
 Make your way to Mérida and on the way visit the magical towns of 
Izamal and Valladolid; making stops at the different cenotes and Mayan 
ceremonial centers.</p><p>
Explore the natural environment in many of 
the parks and preserved heritage sites throughout the Yucatan peninsula.
 Tours and guided excursions offer some incredible local experiences. 
Explore La Ruta de los Cenotes, underground caves, zipline through the 
jungle canopy, or take self-driving ATV or 4X4 adventure through jungle 
roads.
