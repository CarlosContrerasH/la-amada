...
let bigSlider =[ <HandleImages name="cuatroRecamaras1"/>, <HandleImages name="cuatroRecamaras2"/>, <HandleImages name="cuatroRecamaras3"/>, <HandleImages name="cuatroRecamaras4"/>, <HandleImages name="cuatroRecamaras"/>]
...
const Features = (props) => {
    return (<div className="features">
		...
		<button name="Descargar Plano" className="flat-button sand-button centered-button" style={{ margin: "2em" }}>
					<a style={{textDecoration:"none",color:"inherit"}} href="/img/planos/4/plano.jpg"  target="_blank">{props.eng?"DOWNLOAD FLOORPLAN":"Decargar Plano PDF"}</a>
					</button>
...
mapa:34
    ...
    render() {
        ...
        return (
            ...
            <Layout>
                <div className="detalle-hero"> <HandleImages name="cuatroRecamaras5" /></div>
                <Detalle />
                <FloorPlan />
                <Features />
