...
<h1>{props.eng?"Three Bedrooms":"Tres Recámaras"}</h1>
        <div className="content">
            <h3>{props.eng?"From $875,000.00 USD":"Desde $875,000.00 USD"}</h3>
<h3>{props.eng?"Walk straight to the beach club from your ground floor, ocean facing home.		":
"Nuestra unidad de tres recámaras es una gran oportunidad de inversión para familias y parejas que gozan de tener invitados continuamente. Cada departamento cuenta con más de 270m2 de vivienda."}</h3>
...
const Features = (props) => {
    return (<div className="features">
        <div className="wrapper">
            <div className="col">
                ...
                <h4>{props.eng?"Bedroom 2":"Dormitorio 2"}</h4>
                    <div><img alt="Sala Comedor" src={dorm2} /><span>26M<sup>2</sup></span><span>280FT<sup>2</sup></span></div>
                </div>
            </div>
		...
		<button name="Descargar Plano" className="flat-button sand-button centered-button" style={{ margin: "2em" }}>
					<a style={{textDecoration:"none",color:"inherit"}} href="/img/planos/3/plano.jpg"  target="_blank">{props.eng?"DOWNLOAD FLOORPLAN":"Decargar Plano PDF"}</a>
					</button>
