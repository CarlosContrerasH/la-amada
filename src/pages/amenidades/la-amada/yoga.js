...
<path fill="#FFFFFF" d="M133.2,102.1L133.2,102.1c-3.4-3.4-7.3-6.2-11.6-8.3c8-8.8,11.2-19.4,11.2-21.1c0-1.7-1.1-3.1-2.7-3.4
	...
	C119,109.9,110.9,112.8,102.4,112.8z"/>
                ...
                <Link to="/amenidades/la-amada/rooftop-albercas"  >
                <button className="back"  ><span><span className="arrow-back"></span></span><br />{props.eng ?  "Back to Rooftops & Pools" : "Rooftops y Albercas"}</button>
         </Link>   </div>
        </ScrollWrapper>
