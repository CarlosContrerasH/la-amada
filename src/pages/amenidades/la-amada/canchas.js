...
let bigSlider =[  <HandleImages name="canchaH1"/>, <HandleImages name="canchaH2"/>, <HandleImages name="canchaH3"/>]
	...
	<g>
		<path fill="#FFFFFF" d="M70.7,36.8c-22.8,0-41.2,18.4-41.2,41.2s18.4,41.2,41.2,41.2s41.2-18.4,41.2-41.2S93.4,36.8,70.7,36.8z
			...
			c2-2.8,4.4-5.3,7.3-7.3C110.1,66.9,110.1,89.2,96.4,103.1z"/>
                ...
                <Link to="/amenidades/la-amada/yoga"  >
                <button className="back"  ><span><span className="arrow-back"></span></span><br />{props.eng ?  "Back to Yoga and Multipurpose Excercise Room" : "Volver a Salón de Yoga y Usos Múltiples"}</button>
          </Link>  </div>
        </ScrollWrapper>
