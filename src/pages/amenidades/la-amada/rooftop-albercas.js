...
let bigSlider =[ <HandleImages name="rooftop"/>, <HandleImages name="roofH2"/>, <HandleImages name="roofH3"/>]
	...
	<g>
		<g>
			<path fill="#FFFFFF" d="M120.6,127.5c-0.5-1.2-2.1-1.9-3.3-1.2c-12.3,5.3-18.4,2.7-24.8,0c-6.6-2.7-13.3-5.6-25.2,0
                ...
                <Link to="/amenidades/la-amada/beachclub"  >
                <button className="back"  ><span><span className="arrow-back"></span></span><br />{props.eng ? "Back to Beach Club" : "Volver a Club de Playa"}</button>
         </Link>   </div>
        </ScrollWrapper>
