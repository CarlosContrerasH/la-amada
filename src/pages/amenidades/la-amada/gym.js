...
let playaSlider =[<HandleImages name="amenidadesA5"/>, <HandleImages name="gymH1"/>, <HandleImages name="gymH2"/>, <HandleImages name="gymH3"/> ]
    ...
    return (
        ...
        <ScrollWrapper classes="bg-sand amenidad-detalle">
            ...
            <div className="amenidades-top">
                    <Link to="/amenidades/la-amada/ludoteca"  ><button className="back"><span><span className="arrow-back"></span></span><br />PREV</button></Link>
		...
		<path fill="#FFFFFF" d="M132.3,49.2h-5.7c-1,0-2,0.2-2.9,0.5v-9.1c0-4.7-3.9-8.6-8.6-8.6h-5.7c-4.7,0-8.6,3.9-8.6,8.6v20.1H49.2
			...
			c0,1.6-1.3,2.9-2.9,2.9h-5.7c-1.6,0-2.9-1.3-2.9-2.9V57.8c0-1.6,1.3-2.9,2.9-2.9h5.7c1.6,0,2.9,1.3,2.9,2.9V92.2z"/>
                ...
                Gym
                     ...
                     <Link to="/amenidades/la-amada/lobby"  ><button className="back"><span><span className="arrow"></span></span><br />Next</button></Link>
                </div>
