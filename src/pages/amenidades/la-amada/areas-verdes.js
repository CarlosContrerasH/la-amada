...
let bigSlider =[   <HandleImages name="areasVerdes1" class="leftBottom"/>, <HandleImages name="areasVerdes2"  class="centerTop" />,  <HandleImages name="amenidadesA1" class="centerBottom" />]
