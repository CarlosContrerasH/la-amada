...
let bigSlider =[ <HandleImages name="amenidadesP3" class="leftBottom" />,     <HandleImages name="delfinesH1"/> ]
...
<path fill="#FFFFFF" d="M133.8,39.8l-3.3-1.6c-1.2-3.2-4.8-10-13.9-13c-6.2-2.1-22.3-7.4-38.9-2.1c-7.7-6.1-13.5-6.5-25-5
	...
	C139.5,48.5,138.5,42.2,133.8,39.8L133.8,39.8z"/>
             ...
             Caminando por la playa, a tan sólo 7 minutos, se encuentra el lujoso hotel Dreams Playa Mujeres Golf & Spa Resort, donde se alberga Delphinus Playa Mujeres. 
                ...
                <Link to="/amenidades/playa/helipuerto"  >           <button className="back"  ><span><span className="arrow-back"></span></span><br />{props.eng ?  "Back to Heliport" : "Volver a Helipuerto"}</button>
          </Link>  </div>
        </ScrollWrapper>
