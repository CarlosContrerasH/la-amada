...
let bigSlider =[   <HandleImages name="helipuertoH1"/> ]
...
<g>
	...
	<g>
        ...
        Entre palmas y vegetación, se ubica nuestro helipuerto. Aterriza tus sueños junto a tu casa en nuestro condominio.  </>
				...
				<Link to="/amenidades/playa/seguridad"  >
                             <button className="back"  ><span><span className="arrow-back"></span></span><br />{props.eng ?  "Back to Gated Community" : "Volver a Doble Caseta de Seguridad"}</button>
         </Link>   </div>
        </ScrollWrapper>
