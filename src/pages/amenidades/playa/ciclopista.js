...
let bigSlider =[   <HandleImages classes="ciclopista" name="bikeH1"/> ]
		...
		s-3.4-7.6-7.6-7.6c-0.3,0-0.6,0-0.8,0l-6-15.3c2.2-0.6,4.4-1,6.8-1c13.1,0,23.8,10.7,23.8,23.8S142.1,104.1,129,104.1L129,104.1z
		 M125.7,80.2c0-1.8,1.5-3.3,3.3-3.3s3.3,1.5,3.3,3.3c0,1.8-1.5,3.3-3.3,3.3S125.7,82.1,125.7,80.2z"/>
              ...
              {props.eng == true ?"Bike & Running Path":"Ciclopista"}
                ...
                <Link to="/amenidades/playa/spa"  >
                             <button className="back"  ><span><span className="arrow-back"></span></span><br />{props.eng ?  "Back to Spa" : "Volver a Spa"}</button>
